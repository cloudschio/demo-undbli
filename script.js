...
window.addEventListener('scroll',()=>{
  ...
  const sc=(h.scrollTop)/(h.scrollHeight-h.clientHeight||1)*100;
  progressBar.style.width=sc+'%';
});
...
musicBtn.onclick=async()=>{
  try{
    ...
    alert('Browser memblokir autoplay. Klik lagi untuk memulai musik.');
  }
};
...
const cursor=document.getElementById('cursor'), cursor2=document.getElementById('cursor2');
